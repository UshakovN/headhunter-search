...
type Fetcher interface {
  Fetch(context.Context, *VacanciesRequest) (*VacanciesResponse, error)
}
...
func (f *fetcher) Fetch(ctx context.Context, req *VacanciesRequest) (*VacanciesResponse, error) {
  query, err := req.Query()
  if err != nil {
